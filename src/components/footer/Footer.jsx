  ...
  return (
   <footer className="footer">
    <div className="footer__container container">
        ...
        <a href="https://www.instagram.com/" className="home__social-icon footer__social-link" target="_blank">
            <i class="bx bxl-instagram"></i>
        </a>

        <a href="https://github.com/" className="home__social-icon footer__social-link" target="_blank">
            <i class="bx bxl-twitter"></i>
        </a>
        </div>
        <span className="footer__copy">&#169; Cryticalcoder.All rights 
        reserved</span>
    </div>
   </footer>
  )
